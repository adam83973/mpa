...
class StandardsControllerTest < ActionController::TestCase
  ...
  test "should create standard" do
    assert_difference('Standard.count') do
      post :create, standard: { category: @standard.category, description: @standard.description, name: @standard.name }
    end
  ...
  test "should update standard" do
    put :update, id: @standard, standard: { category: @standard.category, description: @standard.description, name: @standard.name }
    assert_redirected_to standard_path(assigns(:standard))
  end
