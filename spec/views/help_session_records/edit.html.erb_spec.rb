...
RSpec.describe "help_session_records/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit help_session_record form" do
    render

    assert_select "form[action=?][method=?]", help_session_record_path(@help_session_record), "post" do
