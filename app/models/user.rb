class User < ActiveRecord::Base
  ...
  attr_accessible :email, :password, :current_password, :password_confirmation, :remember_me, :offering_ids,
                  ...
                  :phone, :role, :shirt_size, :infusion_id, :last_payment, :active_subscription, :send_password_link, :opportunity_id, :subscription_count, :balance_due, :check_appointment_ids
