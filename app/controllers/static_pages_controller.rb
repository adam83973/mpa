class StaticPagesController < ApplicationController
  ...
  def events
    ...
    @workshops = woocommerce.get('products', {filter: {category: 'boy-scouts-workshop', limit: 20} }).parsed_response['products']
  end
  ...
  private
    ...
    def set_teacher
      ...
      @students = Student.all.to_a.delete_if{|student| !student.is_active?}
